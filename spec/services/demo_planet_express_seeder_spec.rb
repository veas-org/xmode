...
RSpec.describe Demo::PlanetExpressSeeder do
  it "seeds an idempotent Bender demo workspace" do
    ...
    expect(workspace.code_model_profiles.find_by!(default_profile: true)).to have_attributes(name: "Oracle Qwen2 Fast", model: "qwen2.5:0.5b")
    ...
    expect(workspace.action_definitions.find_by!(key: "local-model-plan").runtime_config).to include("mode" => "live", "max_tokens" => 512)
