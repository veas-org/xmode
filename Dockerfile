...
# docker build -t xmode_rails_template .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name xmode_rails_template xmode_rails_template
